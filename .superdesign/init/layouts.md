...
The homepage is monolithic. Header, main sections, CTA, and footer all live in `src/App.jsx`, so the complete file is the authoritative layout source.

## Application shell and homepage

- Source: `src/App.jsx`
- Description: Sticky header, one-page marketing homepage, mobile navigation overlay, CTA, and footer.
